...
public class ConfigTable {
	...
	public static void init(String flag) {
		...
		try{
			...
			System.out.println("ConfigTable.class.getResource============="+ConfigTable.class.getResource("/").getPath());
			System.out.println("ConfigTable.class.getResource============="+ConfigTable.class.getResource("").getPath());
			System.out.println("classpath============="+classpath);
			System.out.println("classpath============="+ConfigTable.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
		}catch(Exception e){
			e.printStackTrace();
		}
